...
<?php elseif (isset($_GET['giftcard_id'])  ) : ?>
    ...
    <?php if (has_success()): ?>
        <?php if ($giftcard) : ?>
            <div class="row">
                <div class="col-sm-9">
                    <p class="success_message">Merci d'avoir offert ce bon cadeau d'une valeur de <?php echo convert_cents_to_currency($giftcard->amount); ?> pour <?php echo $giftcard->receiver_first_name; ?>. <a href="<?php echo site_url(); ?>/actions/giftcardprint.php?id=<?php echo $giftcard->id; ?>">Print.</a>  </p>
                </div>
                <div class="col-sm-3">
