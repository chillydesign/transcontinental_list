    ...
    <?php if ($list) : ?>
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-pull-3">
                <h1><?php echo $list->name; ?> | <a href="<?php get_site_url(); ?>/mariage/<?php echo $list->id; ?>">#<?php echo $list->id; ?></a></h1>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <p><a href="<?php echo site_url(); ?>/adminarea/list?id=<?php echo $list->id; ?>&status=payé">payé</a> |
                                ...
                                <a href="<?php echo site_url(); ?>/adminarea/list?id=<?php echo $list->id; ?>&status=annulé">annulé</a>
                            </p>
                        </div>
